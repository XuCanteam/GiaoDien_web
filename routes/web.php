...
use App\Http\Controllers\frontend\ContactController as LienHenController;
...
Route::get('chi-tiet-san-pham/{slug}',[SanPhamController::class, 'detail'])->name('site.product_detail');
Route::get('lien-he',[LienHenController::class, 'index'])->name('site.contact');
